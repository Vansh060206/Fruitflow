...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        pass: process.env.GMAIL_PASS, // This MUST be a 16-character Google App Password
    },
    tls: {
        rejectUnauthorized: false // Helps avoid SSL/TLS handshake errors in dev environments
    },
    debug: true, // Enable detailed SMTP logs
    logger: true // Log SMTP state to the console
});
