            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className={`md:col-span-2 bg-card/50 backdrop-blur-sm border-border p-6 transition-all duration-700 delay-100 dark:bg-white/5 dark:border-white/10 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button className="text-sm text-emerald-600 hover:text-emerald-700 flex items-center gap-1 transition-colors dark:text-emerald-400 dark:hover:text-emerald-300">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-1">
                                <label className="text-sm text-muted-foreground dark:text-white/40">Company Name</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-sm text-muted-foreground dark:text-white/40">Contact Email</label>
                                <p className="text-foreground font-medium flex items-center gap-2 dark:text-white">
                            ...
                            <div className="space-y-1">
                                <label className="text-sm text-muted-foreground dark:text-white/40">Business Phone</label>
                                <p className="text-foreground font-medium flex items-center gap-2 dark:text-white">
                            ...
                            <div className="space-y-1">
                                <label className="text-sm text-muted-foreground dark:text-white/40">Headquarters</label>
                                <p className="text-foreground font-medium flex items-center gap-2 dark:text-white">
                ...
                <Card className={`bg-card/50 backdrop-blur-sm border-border p-6 transition-all duration-700 delay-200 dark:bg-white/5 dark:border-white/10 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                    <h3 className="text-xl font-semibold text-foreground mb-6 flex items-center gap-2 dark:text-white">
                        <Store className="w-5 h-5 text-emerald-600 dark:text-emerald-500" />
                        Business Details
                    </h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm text-muted-foreground dark:text-white/40">Total Sales</label>
                            <p className="text-foreground font-medium dark:text-white">{userData?.totalSales || 0} Orders Fulfilled</p>
                        </div>
                    </div>
                </Card>
            </div>
