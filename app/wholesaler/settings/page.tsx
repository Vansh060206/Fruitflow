                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      id="email"
                      type="email"
                      defaultValue="john@fruitflow.com"
                      className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      id="shop-name"
                      type="text"
                      defaultValue="Fresh Fruits Wholesale"
                      className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      id="language"
                      className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white appearance-none cursor-pointer focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                    >
                  ...
                  <label className="flex items-center justify-between p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg cursor-pointer hover:bg-white/10 transition-all">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/60 text-sm">Receive order and stock alerts</p>
                      </div>
                    </div>
                    <button
                      type="button"
                      ...
                      className={`relative w-14 h-7 rounded-full transition-colors ${
                        notificationsEnabled ? "bg-emerald-500" : "bg-white/20"
                      }`}
                    >
                      <span
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white text-sm font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-emerald-500/10 border border-white/10">
                      Change Password
                    </button>
                  </div>
                </div>

                <div className="p-4 bg-emerald-500/5 backdrop-blur-sm border border-emerald-500/20 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <button className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-emerald-500/30">
                        Enable 2FA
                      </button>
                    </div>
                  </div>
