    ...
    <div className="min-h-screen w-full bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        {[
          ...
          <div
            key={`back-${i}`}
            className={`absolute ${fruit.size} ${fruit.opacity} ${fruit.blur}`}
            style={{
              left: fruit.left,
              top: fruit.top,
        ...
        {[
          ...
          <div
            key={`front-${i}`}
            className={`absolute ${fruit.size} opacity-30`}
            style={{
              left: fruit.left,
              top: fruit.top,
      ...
      <div
        className="absolute left-0 top-1/2 -translate-y-1/2 w-96 h-96 rounded-full opacity-20 pointer-events-none blur-3xl"
        style={{
      ...
      <div
        className={`bg-white/5 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl max-w-md w-full relative z-10 transition-all duration-700 hover:shadow-[0_0_50px_rgba(16,185,129,0.15)] ${
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 focus:shadow-[0_0_20px_rgba(16,185,129,0.2)] transition-all duration-300"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-3 rounded-lg transition-all duration-300 hover:scale-[1.02] relative overflow-hidden group"
            style={{
